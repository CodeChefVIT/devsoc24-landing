...
const trackDetails: Track[] = [
  {
    name: "Interactive Engagement (Gamified Solutions)",
    content:
  ...
  {
    name: "Eco-Innovations (Sustainable Technology)",
    content:
          ...
          >
            ...
            {trackModal[index] && (
              <Draggable bounds=".boundarybox">
                <div
                  className={`fixed top-16 z-50 lg:absolute ${index == 0 ? "left-28" : ""}  flex h-fit w-[100vw] flex-col overflow-y-auto overflow-x-hidden border-2 bg-[#b2b2b2] pb-10 md:w-[500px] `}
                >
                  <div className="drag-handle flex h-[25px] items-center justify-between border-b-2 bg-gradient-to-r from-blue-800 to-blue-600">

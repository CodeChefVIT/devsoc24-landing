...
export default function Prizepool() {
  ...
  return (
    ...
    >
      <div
        className={`${isSmaller ? "" : "absolute left-[31%] top-16 "} z-50 flex h-fit min-w-[300px]  flex-col ${maximized ? "h-[100vh] w-[100vw] sm:h-full sm:w-full" : " w-[30vw]"} border-2 bg-[#b2b2b2] pb-3`}
      >
      ...
      <div
        className={`flex  ${isSmaller ? "flex-col" : "flex-row absolute bottom-16 w-full"}   justify-evenly`}
      >
        <div
        ...
        >
          ...
          >
            ...
            <div
              className={`flex  ${isSmaller ? "flex-col gap-y-6  w-full justify-center items-center " : "flex-row gap-x-4 w-fit"} `}
            >
